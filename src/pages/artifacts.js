  ...
  const components = [
    ...
    // FlowBiteCta1 CTA
    {
      ...
      props: {
        ...
        description: 'Your description text goes here. Make it engaging and informative.',
    ...
    // FlowBiteCta2 CTA
    {
      ...
      props: {
        ...
        description: "Discover a world of endless possibilities with our cutting-edge tools and features.",
        primaryButton: {
          text: "Sign Up Now", 
          link: "/signup"
        },
