    ...
    <Layout>
      <div className='container mt-4 '>
        <div className='max-w-2xl mx-auto p-4 bg-white rounded-lg shadow-md'>
          ...
          <p className='mb-4'>
            Our service allows users to subscribe and participate in our mission
            to end hunger in Africa. Subscribers earn a percentage of the
            subscription fees paid by their recruits, which is used for various
            purposes, including contributing to food parcels and sustaining the
            system.
          </p>
          ...
          <p className='mb-4'>
            ...
            fraudulent activity, or any other actions detrimental to our
            mission.
          </p>
          ...
          <p className='mb-4'>
            ...
            to contact us for any reason, please reach out to us at
            inaethe@example.com.
          </p>
        </div>
      </div>
