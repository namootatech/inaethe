...
const WhyInaEthe = ({ theme }) => {
  return (
    <div
      className={`h-full w-full px-10 py-10 px-10 text-center md:text-left ${theme?.spaSection?.bg} ${theme?.spaSection?.fg} text-center`}
    >
...
export default connect(mapStateToProps)(WhyInaEthe);
