    ...
    <div className='relative w-full h-screen flex flex-col justify-center items-center'>
      ...
      <div className='flex justify-start items-start'>
        <div className='h-auto px-8 py-8 text-center md:text-left md:col-span-2'>
          <h1 className='white-text text-red-700 text-4xl md:text-7xl mb-4 font-extrabold leading-none tracking-tight text-gray-900 dark:text-gray-900'>
            {rest?.header}
          </h1>
          {rest?.subHeader && (
            <h2 className='white-text text-5xl mb-4 font-extrabold leading-none tracking-tight text-gray-900 dark:text-gray-900'>
              {rest?.subHeader}
            </h2>
          )}
