      ...
      <section class='relative pt-10 xl:pt-14'>
        <div class='mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 flex flex-col lg:flex-row gap-8 lg:gap-10 xl:gap-12'>
          <div class='mx-auto text-center lg:text-left flex flex-col max-w-3xl justify-center lg:justify-start lg:py-8 flex-1 lg:w-1/2 lg:max-w-none'>
            <h1
              class={`text-${siteConfig.colors.primaryColorCode}  dark:text-${siteConfig.colors.darksiteConfigTextColorCode}  text-4xl/snug sm:text-6xl/tight lg:text-5xl/tight xl:text-6xl/tight font-semibold text`}
            >
              {title}
            </h1>
            <p
              class={`mt-10 text-${siteConfig.colors.textColorCode}  dark:${siteConfig.colors.darksiteConfigTextColorCode}  lg:text-lg max-w-2xl lg:max-w-none mx-auto`}
            >
              {description}
            </p>
          ...
          <div class='flex flex-1 lg:w-1/2 relative max-w-3xl mx-auto lg:max-w-none'>
            ...
            <div class='absolute left-1/2 -translate-x-1/2 lg:-translate-x-0 -bottom-10 w-60 p-4 rounded-lg bg-white dark:bg-gray-950 border dark:border-gray-800'>
              <div
                class={`flex children:ring-4 children:ring-white dark:children:ring-${siteConfig.colors.textColorCode}  children:w-9 children:h-9 children:object-cover children:-ml-1 children:rounded-full`}
              >
              ...
              <div>
                <p
                  class={`text-lg font-semibold text-${siteConfig.colors.primaryColorCode}  dark:text-white`}
                >
                  {ratings.title}
                </p>
...
export const FlexwindHero2 = ({ siteConfig, ...rest }) => {
...
export const FlexwindHero3 = ({ siteConfig, ...rest }) => {
...
export const FlexwindHero4 = ({ siteConfig, data, ...rest }) => {
...
export const FlexwindHero5 = ({ siteConfig, ...rest }) => {
